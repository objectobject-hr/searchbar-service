...
const SearchBar = ({flasher, searchText}) => (
  <div data-namespace="search-box" data-version="v1.130.0">
    <form role="search" action="https://www.ikea.com/us/en/search/" class="search-box">
      <div class="search-field">
        ...
        <input type="search" value={searchText} name="q" class="search-field__input" spellCheck="false" aria-label="Search by product" aria-placeholder="Search by product" autoCapitalize="off" autoComplete="off" autoCorrect="off"></input>    
